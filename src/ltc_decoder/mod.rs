...
pub trait Sample:
    Zero + Ord + Clone + Copy + FromPrimitive + ToPrimitive + Display + 'static
{
}

impl<T> Sample for T where
    T: Zero + Ord + Clone + Copy + FromPrimitive + ToPrimitive + Display + 'static
{
}

pub struct LtcDecoder<T: Sample + Debug> {
    ltc_frame: LtcFrame,
    bit_decoder: BitDecoder<T>,
    sampling_rate: f32,
}

impl<T: Sample + Debug> LtcDecoder<T> {
...
impl<T: Sample + Debug> LtcDecoder<T> {
    ...
    pub fn get_timecode_frame(&mut self, sample: T) -> Option<TimecodeFrame> {
        ...
        match self.bit_decoder.get_bit(sample) {
            ...
            BitVal::True => {
                self.ltc_frame.shift_bit(true);
            }
            BitVal::False => {
                self.ltc_frame.shift_bit(false);
            }
        }
...
mod tests {
    ...
    fn test_ltc_00100000_2mins_25fps_44100x8() {
        test_timecode_file(
            ...
            TimecodeFrame::new(0, 12, 0, 24, TwentyFive),
        )
    }
    ...
    fn test_ltc_00500000_2mins_30fps_44100x8() {
        test_timecode_file(
            "testfiles/LTC_00500000_2mins_30fps_44100x8.wav",
            TimecodeFrame::new(0, 50, 0, 1, Thirty),
            TimecodeFrame::new(0, 52, 0, 29, Thirty),
        )
    }
    ...
    fn test_ltc_10000000_2mins_24fps_44100x16() {
        test_timecode_file(
            "testfiles/LTC_10000000_2mins_24fps_44100x16.wav",
            TimecodeFrame::new(10, 0, 0, 1, TwentyFour),
            TimecodeFrame::new(10, 2, 0, 23, TwentyFour),
        )
    }
    ...
    fn test_ltc_10100000_2mins_25fps_44100x16() {
        test_timecode_file(
            "testfiles/LTC_10100000_2mins_25fps_44100x16.wav",
            TimecodeFrame::new(10, 10, 0, 1, TwentyFive),
            TimecodeFrame::new(10, 12, 0, 24, TwentyFive),
        )
    }
    ...
    fn test_ltc_10400000_2mins_30fps_44100x16() {
        test_timecode_file(
            "testfiles/LTC_10400000_2mins_30fps_44100x16.wav",
            TimecodeFrame::new(10, 40, 0, 1, Thirty),
            TimecodeFrame::new(10, 42, 0, 29, Thirty),
        )
    }
    ...
    fn test_ltc_10500000_2mins_24fps_48000x16() {
        test_timecode_file(
            "testfiles/LTC_10500000_2mins_24fps_48000x16.wav",
            TimecodeFrame::new(10, 50, 0, 1, TwentyFour),
            TimecodeFrame::new(10, 52, 0, 23, TwentyFour),
        )
    }
    ...
    fn test_ltc_11000000_2mins_25fps_48000x16() {
        test_timecode_file(
            "testfiles/LTC_11000000_2mins_25fps_48000x16.wav",
            TimecodeFrame::new(11, 0, 0, 1, TwentyFive),
            TimecodeFrame::new(11, 2, 0, 24, TwentyFive),
        )
    }
    ...
    fn test_ltc_11300000_2mins_30fps_48000x16() {
        test_timecode_file(
            "testfiles/LTC_11300000_2mins_30fps_48000x16.wav",
            TimecodeFrame::new(11, 30, 0, 1, Thirty),
            TimecodeFrame::new(11, 32, 0, 29, Thirty),
        )
    }
    ...
    fn test_ltc_11400000_2mins_24fps_44100x16() {
        test_timecode_file(
            "testfiles/LTC_11400000_2mins_24fps_44100x16.wav",
            TimecodeFrame::new(11, 40, 0, 1, TwentyFour),
            TimecodeFrame::new(11, 42, 0, 23, TwentyFour),
        )
    }
    ...
    fn test_ltc_11500000_2mins_25fps_44100x16() {
        test_timecode_file(
            "testfiles/LTC_11500000_2mins_25fps_44100x16.wav",
            TimecodeFrame::new(11, 50, 0, 1, TwentyFive),
            TimecodeFrame::new(11, 52, 0, 24, TwentyFive),
        )
    }
    ...
    fn test_ltc_12200000_2mins_30fps_44100x16() {
        test_timecode_file(
            "testfiles/LTC_12200000_2mins_30fps_44100x16.wav",
            TimecodeFrame::new(12, 20, 0, 1, Thirty),
            TimecodeFrame::new(12, 22, 0, 29, Thirty),
        )
    }
    ...
    /// Frame (usually 1 frame above the start of the audio, because the lib needs some tim to sync)
    /// and the last expected decoded Frame
    fn test_timecode_frames<T: Sample + Debug>(
        sampling_rate: u32,
        samples: Vec<T>,
        first_tc: TimecodeFrame,
        last_tc: TimecodeFrame,
    ) {
    ...
    fn get_left_channel(channel_count: u16, samples: BitDepth) -> BitDepth {
        ...
        match samples {
            BitDepth::Eight(samples) => {
                BitDepth::Eight(samples.iter().skip(1).step_by(2).copied().collect())
            }
            BitDepth::Sixteen(samples) => {
                BitDepth::Sixteen(samples.iter().skip(1).step_by(2).copied().collect())
            }
            BitDepth::TwentyFour(samples) => {
                BitDepth::TwentyFour(samples.iter().skip(1).step_by(2).copied().collect())
            }
            BitDepth::ThirtyTwoFloat(samples) => {
                BitDepth::ThirtyTwoFloat(samples.iter().skip(1).step_by(2).copied().collect())
            }
